...
public class AccountService {
    ...
    private void makeDebit(Account sendAccount, Account takeAccount, int money) throws LimitAccountException {
        ...
        logger.info("Завершен перевод средств с аккаунта " + sendAccount.getId()
                + " на аккаунт " + takeAccount.getId() + " итоговый счет аккаунта отправителя - "
                + sendAccount.getCurrentAmount() + " Итоговый счет аккаунта получателя - " + takeAccount.getCurrentAmount());
    }
